...
def conf(args_list=None):
    parser = argparse.ArgumentParser(description="SimCLR Model Training")
    # model name
    ...
    parser.add_argument("--epochs", default=65, type = int, help="end epoch")
    ...
    parser.add_argument("--val_batch_size", default=512, type=int, help="input batch size for testing")
    ...
    parser.add_argument("--save-interval", default=4, type = int, help="save every N epoch")
    ...
    parser.add_argument('--resume', default='./data/weight/resnet18/rwave-1024/202410262216/checkpoint_epoch_40.pth.tar', type=str, help='path to latest checkpoint (default: none)')
