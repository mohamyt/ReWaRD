...
def conf(args_list=None):
    ...
    parser.add_argument('--resume', default='./data/weight/SimCLR.tar', type=str, help='path to latest checkpoint (default: none)')
    parser.add_argument("--path2db", default="/home/hpc/iwi9/iwi9120h/ReWaRD-Unsupervised-Learning/SimCLR/data/rwave-1024/rwave-1024.lmdb", type = str, help="path to dataset training images") #dataset path 
