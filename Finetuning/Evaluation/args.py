...
def conf(args_list=None):
    ...
    parser.add_argument("--model_type", default="SimCLR", type = str, help="Pretrained model type [Autoencoder, SimCLR, LDL]")
    ...
    parser.add_argument("--scheduler_milestones", default=[60, 90, 120, 160, 180, 200, 230], type=int, nargs='+', help="epochs at which to decay learning rate")
    ...
    parser.add_argument("--path2model", default=f"./data/weight/Pretrained/{args.model_type}.tar", type = str, help="path to dataset training images")
    parser.add_argument("--path2traindb", default="D:/FAU/SS24/Retinal Waves Project/Unsupervised Learning using ReWaRD/Finetuning/Evaluation/data/ImageNet1k/train", type = str, help="path to dataset training images")
    parser.add_argument("--path2valdb", default="D:/FAU/SS24/Retinal Waves Project/Unsupervised Learning using ReWaRD/Finetuning/Evaluation/data/ImageNet1k/val", type = str, help="path to dataset validation images")
