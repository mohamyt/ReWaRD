...
def conf(args_list=None):
    ...
    parser.add_argument("--model_type", default="None", type = str, help="Pretrained model type")
    ...
    parser.add_argument("--scheduler_gamma", default=0.5, type=float, help="learning rate decay factor")
